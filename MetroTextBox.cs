...
public class MetroTextBox : Control, IMetroControl
{
    ...
    public class MetroTextButton : Button, IMetroControl
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            Font font = Font;
            TextRenderer.DrawText(e.Graphics, Text, font, base.ClientRectangle, red, color, TextFormatFlags.EndEllipsis | TextFormatFlags.HorizontalCenter | TextFormatFlags.VerticalCenter);
            DrawIcon(e.Graphics);
        }
