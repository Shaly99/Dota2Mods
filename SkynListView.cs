...
public class SkynListView : ListView
{
    ...
    private void MetroListView_DrawSubItem(object sender, DrawListViewSubItemEventArgs e)
    {
        ...
        if (base.View == View.Details)
        {
            ...
            TextRenderer.DrawText(e.Graphics, e.SubItem.Text, stdFont, bounds, color, textFormatFlags | TextFormatFlags.SingleLine | TextFormatFlags.VerticalCenter | TextFormatFlags.WordEllipsis);
            return;
        }
        e.DrawDefault = true;
    }
    ...
    private void MetroListView_DrawItem(object sender, DrawListViewItemEventArgs e)
    {
        ...
        if ((base.View == View.Details) | (base.View == View.List) | (base.View == View.SmallIcon))
        {
            ...
            if (base.View != View.Details)
            {
                ...
                bounds = new Rectangle(e.Bounds.X + num2, e.Bounds.Y, num5 - num, e.Item.Bounds.Height);
                TextRenderer.DrawText(e.Graphics, e.Item.Text, stdFont, bounds, color, textFormatFlags | TextFormatFlags.SingleLine | TextFormatFlags.VerticalCenter | TextFormatFlags.WordEllipsis);
            }
            return;
        }
        if (base.View == View.Tile)
        {
            ...
            {
                int num7 = 0;
                num6 = base.LargeImageList.ImageSize.Width + 2;
                Image image2 = null;
                if (e.Item.ImageIndex > -1)
                {
                ...
                if (image2 != null)
                {
                    num7 = (e.Item.Bounds.Height - image2.Height) / 2;
                    e.Graphics.DrawImage(image2, new Rectangle(e.Item.Bounds.Left + num6, e.Item.Bounds.Top + num7, image2.Width, image2.Height));
                }
            }
            if (e.Item.Selected)
            {
                Rectangle rect3 = new Rectangle(e.Item.Bounds.X + num6, e.Item.Bounds.Y, e.Item.Bounds.Width, e.Item.Bounds.Height);
            ...
            int num8 = 0;
            {
                ...
                {
                    if (num8 > 0 && !e.Item.Selected)
                    {
                        color = Color.Silver;
                    }
                    int num9 = e.Item.Bounds.Y;
        ...
        if (base.CheckBoxes)
        {
            int num11 = e.Bounds.Height / 2 - 6;
            using (Pen pen2 = new Pen(Color.Black))
            {
                Rectangle rect4 = new Rectangle(e.Bounds.X + 6, e.Bounds.Y + num11, 12, 12);
            ...
            if (e.Item.Checked)
            {
                ...
                num11 = e.Bounds.Height / 2 - 4;
                Rectangle rect5 = new Rectangle(e.Bounds.X + 8, e.Bounds.Y + num11, 9, 9);
            ...
            e.Graphics.DrawString(e.Item.Text, stdFont, new SolidBrush(color), rectangle);
        }
        Font = stdFont;
        e.DrawDefault = true;
    }
