public static class Paths
{
    ...
    public static string ServerBasePath { get; private set; }

    public static string ServerRawBasePath { get; private set; }

    public static string ContentBasePath { get; private set; }

    public static string ContentRawBasePath { get; private set; }

    public static string AppCachePath { get; private set; }

    public static string AppCachePatchesPath { get; private set; }

    public static string ServerAchivementSchemasPath { get; private set; }

    public static string ClientConfigurationsPath { get; private set; }

    public static string WwwBasePath { get; private set; }

    public static string CloudBasePath { get; private set; }

    public static string RichPresencesBasePath { get; private set; }
