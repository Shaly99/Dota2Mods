...
public class Media
{
    ...
    public int Position
    {
        ...
        set
        {
            seconds = value;
            seconds *= 1000;
            sCommand = "play MediaFile from " + seconds;
            mciSendString(sCommand, null, 0, IntPtr.Zero);
        }
    }
    ...
    public int Volume
    {
        ...
        set
        {
            if (value <= 1000)
            {
                mciSendString("setaudio MediaFile volume to " + value, null, 0, IntPtr.Zero);
            }
            else
            {
    ...
    private void timer1_Tick(object sender, EventArgs e)
    {
        ...
        this.PositionChanged?.Invoke(this, e2);
    }
    ...
    public void PlayWavResource(string wav)
    {
        ...
        Stream manifestResourceStream = Assembly.GetExecutingAssembly().GetManifestResourceStream(name + "." + wav);
