...
internal class VpkFile : IDisposable
{
    ...
    public uint DataOffset => Version switch
    {
        1u => 12u,
        2u => 28u,
        _ => throw new InvalidOperationException("Called DataOffset on a VpkFile with unknown version"),
    };
